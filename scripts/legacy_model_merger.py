...
python -m scripts.legacy_model_merger merge \
    --backend fsdp \
    --local_dir checkpoints/tau_retail_async_rl/qwen_tau_retail_multiturn_train_split/global_step_6/actor \
    --target_dir checkpoints/tau_retail_async_rl/qwen_tau_retail_multiturn_train_split/global_step_6/actor/huggingface
```
