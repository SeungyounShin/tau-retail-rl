...
class ExchangeDeliveredOrderItems(BaseTool):
    ...
    async def execute(self, instance_id: str, parameters: dict[str, Any], **kwargs) -> tuple[ToolResponse, float, dict]:
        ...
        if order["status"] != "delivered":
            return ToolResponse(text="Error: non-delivered order cannot be exchanged"), 0.0, {}
        ...
        if item_ids:
            ...
            return ToolResponse(text="Error: no items to be exchanged"), 0.0, {}
        ...
        if (
            ...
            return (
                ToolResponse(text="Error: insufficient gift card balance to pay for the price difference")
            ), 0.0, {}
